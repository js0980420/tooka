import type { DesignSystem, Page, SlideMeta, SlideTransition } from '@open-cards/core';
  ...
  <div style={fillLight}>
    ...
    >
      ...
      <div>
        ...
        >
          A hands-on guide to running open-cards in the Replit Agent — install it, preview the
      ...
      >
        ...
        >
          <Step n="01" title="Ask the Agent to init">
            ...
            >
              <span style={{ color: p.accent }}>$</span> npx @open-cards/cli init
            </code>
          </Step>
          <Step n="02" title="Open &amp; explore">
            open-cards boots in the webview. Click any example slide to view it in the deck.
          </Step>
        </div>
        ...
        >
          <div>
            <Shot
              src={initCommand}
              ratio={1534 / 238}
              alt="Typing the open-cards init command into the Replit Agent prompt"
            />
          ...
          <div>
            <Shot
              src={openslideHome}
              ratio={3818 / 1780}
              alt="open-cards home page running inside Replit with an example slide"
            />
            <Caption>open-cards running in your Repl — examples ready to open.</Caption>
          </div>
        </div>
      </div>
    </div>
      ...
      >
        <div className="rf-fadeUp" style={{ animationDelay: '0.3s' }}>
          <Shot
            ...
            ratio={3815 / 1783}
            alt="A finished Replit features slide deck rendered in open-cards inside Replit"
          />
      ...
      >
        <div className="rf-fadeUp" style={{ animationDelay: '0.18s' }}>
          ...
          >
            ...
            >
              open-cards-init--ridemountainpig.replit.app
            </span>
          </div>
        </div>
        ...
        <div className="rf-fadeUp" style={{ animationDelay: '0.3s' }}>
          <Shot
            src={replitDeploy}
            ratio={2950 / 1158}
            alt="Replit Publishing panel showing the open-cards deck deploying to a live replit.app URL"
          />
  ...
  >
    ...
    >
      ...
      <div>
        ...
        >
          Spin up a Repl, run{' '}
          <code style={{ fontFamily: font.mono }}>npx @open-cards/cli init</code>, and let the Agent
          design your slides.
        </p>
      </div>
...
export const meta: SlideMeta = {
  title: 'Using open-cards in Replit',
  theme: 'replit',
