  ...
  return (
    ...
    >
      <span>
        ...
        <span style={{ color: text2 }}>open-cards</span>
      </span>
  ...
  const lines: { code: ReactNode; tag?: string; tagColor?: string }[] = [
    {
      code: (
        <>
          ...
          <Token c={violet}>from</Token> <Token c={mint}>'@open-cards/core'</Token>
          {';'}
        </>
      ),
    },
    ...
    <div style={{ ...fill, padding: '120px 100px' }}>
      ...
      >
        ...
        >
          ...
          <div style={{ color: 'var(--osd-accent)' }}>virtual:open-cards/slides</div>
          <div style={{ height: 14 }} />
...
const VitePluginHooks: Page = () => {
  const hooks = [
    ...
    { name: 'resolveId()', desc: 'claim the three virtual:open-cards/* ids', tint: mint },
...
const Cli: Page = () => {
  const cmds = [
    ...
    { cmd: 'open-cards build', desc: 'viteBuild() → static SPA in dist/', tint: mint },
    { cmd: 'open-cards preview', desc: 'serve dist/ for local check', tint: warm },
    {
      cmd: 'npx @open-cards/cli init',
...
export const meta: SlideMeta = { title: 'Inside open-cards', createdAt: '2026-05-05T17:45:52Z' };
