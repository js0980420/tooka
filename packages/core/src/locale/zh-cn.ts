...
export const zhCN: Locale = {
  ...
  themes: {
    ...
    noThemesHintSuffix: ' 来创建品牌 — 一个位于 themes/ 的 markdown 文件，加上同名的示范卡片。',
    noDemoYet: '尚无 demo',
    noDemoHintPrefix: '对此品牌重新运行 ',
    noDemoHintSuffix: ' 即可生成预览卡片。',
    backToGallery: '返回品牌列表',
    pageOf: '第 {n}/{total} 页',
    nextPageAria: '下一页',
    prevPageAria: '上一页',
    openThemeAria: '打开品牌 {name}',
    usedBy: '使用此品牌的轮播',
    usedByEmpty: '尚未有轮播使用此品牌。',
