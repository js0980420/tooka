...
export const ja: Locale = {
  ...
  themes: {
    title: 'ブランド',
    noThemesTitle: 'ブランドがまだありません',
    noThemesHintPrefix: '',
    noThemesHintSuffix:
      ' を実行して作成 — themes/ に markdown ファイルと同名のデモカードを置きます。',
    noDemoYet: 'デモがまだありません',
    noDemoHintPrefix: 'このブランドで ',
    noDemoHintSuffix: ' を再実行するとプレビューカードが生成されます。',
    backToGallery: 'ブランド一覧へ戻る',
    pageOf: '{n}/{total} ページ',
    nextPageAria: '次のページ',
    prevPageAria: '前のページ',
    openThemeAria: 'ブランド {name} を開く',
    usedBy: 'このブランドを使うカルーセル',
    usedByEmpty: 'このブランドを使うカルーセルはまだありません。',
