...
export const en: Locale = {
  ...
  publish: {
    ...
    toastExternalLinks: 'Remove external links from the {platforms} caption before publishing.',
    toastInvalidInstagramHashtags:
      'Instagram requires exactly 5 unique hashtags. Do not add extra hashtags to the caption.',
    toastInvalidTopicTag:
      'Threads requires one topic tag without #, periods (.), or ampersands (&).',
    toastInstagramCardLimit: 'Instagram API publishing supports up to 10 cards.',
    toastAnalyzingCard: 'Reading the card deck and shaping platform captions…',
    toastCaptionsGenerated: 'Found the hook, key points, and CTA and generated three captions.',
    toastAnalyzeFailed: 'Could not analyze the card deck: {error}',
    ...
    stepGenerateText: '2. Generate platform captions',
    generateTextHint:
      'Read each card in order, identify the hook, key points, and CTA, then adapt them per platform.',
    analyzingCard: 'Analyzing cards…',
    generateCaptions: 'Analyze and apply to all',
    regenerateCaptions: 'Analyze and replace drafts',
    analysisEmpty: 'Pick a card deck to analyze. Every platform draft remains editable.',
    insightHook: 'Hook',
    insightKeyPoints: 'Key points',
    insightCta: 'CTA',
    insightPage: 'Card {page}',
    insightCount: '{count} key points',
    insightGenerated: 'No clear CTA found; added a suggestion',
    ...
    igHashtagsLabel: 'Hashtags (exactly 5, appended below the caption)',
    igHashtagPlaceholder: 'Tag {n}',
    threadsTopicTagPlaceholder: 'Topic tag (required, no #, one per post)',
