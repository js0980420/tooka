...
export const zhTW: Locale = {
  ...
  themes: {
    ...
    noThemesHintSuffix: ' 來建立品牌 — 一個位於 themes/ 的 markdown 檔案，加上同名的示範卡片。',
    noDemoYet: '尚無 demo',
    noDemoHintPrefix: '對此品牌重新執行 ',
    noDemoHintSuffix: ' 即可產生預覽卡片。',
    backToGallery: '返回品牌列表',
    pageOf: '第 {n}/{total} 頁',
    nextPageAria: '下一頁',
    prevPageAria: '上一頁',
    openThemeAria: '開啟品牌 {name}',
    usedBy: '使用此品牌的輪播',
    usedByEmpty: '尚未有輪播使用此品牌。',
